...
tval_desc2 tvals[] =
{
	...
	{ TV_BOLT, "Bolts" },
	{ TV_SHOT, "Shots" },
	{ TV_AMMO_PISTOL, "Pistol Ammo" },
	{ TV_AMMO_RIFLE, "Rifle Ammo" },
	{ TV_AMMO_SHOTGUN, "Shotgun Shells" },
	{ TV_AMMO_SMG, "SMG Ammo" },
	{ TV_AMMO_ASSAULT, "Assault Rifle Ammo" },
	{ TV_SHIELD, "Shield" },
	{ TV_CROWN, "Crown" },
	{ TV_HELM, "Helm" },
	{ TV_GLOVES, "Gloves" },
...
static void do_cmd_wiz_play(void)
{
	...
	s = "You have nothing to play with. There needs to be a very looooooong message now so that your next keystroke isn't misinterpreted as something you didn't want to do at all, so as to force a --More--.";
