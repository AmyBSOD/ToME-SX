...
add_mkey
{
	...
	["fct"]	 = function()
			...
			if weapon.tval == TV_POLEARM and (weapon.sval == SV_HALBERD or weapon.sval == SV_PIKE or weapon.sval == SV_HEAVY_LANCE or weapon.sval == SV_LANCE or weapon.sval == SV_GREAT_POLEAXE or weapon.sval == SV_HELMET_BEARD) then
			else
