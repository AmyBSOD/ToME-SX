...
/*
 * Set "p_ptr->tim_dragonblood_fire", notice observable changes
 */
bool set_tim_dragonblood_fire(int v)
{
	bool notice = FALSE;
...
/*
 * Set "p_ptr->tim_dragonblood_cold", notice observable changes
 */
bool set_tim_dragonblood_cold(int v)
{
	bool notice = FALSE;
...
/*
 * Set "p_ptr->tim_dragonblood_elec", notice observable changes
 */
bool set_tim_dragonblood_elec(int v)
{
	bool notice = FALSE;
	...
	if (v)
	{
		...
		{
			msg_print("You feel more resistant to lightning!");
...
/*
 * Set "p_ptr->tim_dragonblood_acid", notice observable changes
 */
bool set_tim_dragonblood_acid(int v)
{
	bool notice = FALSE;
	...
	if (v)
	{
		...
		{
			msg_print("You feel more resistant to acid!");
			msg_print("You feel less resistant to lightning!");
			notice = TRUE;
		}
	}
...
/*
 * Set "p_ptr->tim_esp_pot", notice observable changes
 */
bool set_tim_esp_pot(int v)
{
	bool notice = FALSE;
...
/*
 * Set "p_ptr->tim_levi_pot", notice observable changes
 */
bool set_tim_levi_pot(int v)
{
	bool notice = FALSE;
	...
	if (v)
	{
		...
		{
			msg_print("You float into the air!");
			notice = TRUE;
		}
	}
	...
	else
	{
		if (p_ptr->tim_levi_pot)
		{
			msg_print("You float gently to the ground.");
			notice = TRUE;
		}
	}

	/* Use the value */
	p_ptr->tim_levi_pot = v;
...
/*
 * Set "p_ptr->tim_jolt_fa", notice observable changes
 */
bool set_tim_jolt_fa(int v)
{
	bool notice = FALSE;
	...
	if (v)
	{
		...
		{
			msg_print("You feel resistant to paralysis!");
			notice = TRUE;
		}
	}
	...
	else
	{
		if (p_ptr->tim_jolt_fa)
		{
			msg_print("You feel less resistant to paralysis!");
			notice = TRUE;
		}
	}
...
/*
 * Set "p_ptr->tim_boost_pot", notice observable changes
 */
bool set_tim_boost_pot(int v)
{
	bool notice = FALSE;
	...
	if (v)
	{
		...
		{
			msg_print("You gain massive power.");
			notice = TRUE;
		}
	}
	...
	else
	{
		if (p_ptr->tim_boost_pot)
		{
			msg_print("The massive power inside you fades.");
			notice = TRUE;
		}
	}

	/* Use the value */
	p_ptr->tim_boost_pot = v;
...
/*
 * Set "p_ptr->tim_luck_pot", notice observable changes
 */
bool set_tim_luck_pot(int v)
{
	bool notice = FALSE;
	...
	else
	{
		if (p_ptr->tim_luck_pot)
		{
			msg_print("Your luck has timed out.");
			notice = TRUE;
		}
	}

	/* Use the value */
	p_ptr->tim_luck_pot = v;
...
/*
 * Set "p_ptr->tim_reshi_pot", notice observable changes
 */
bool set_tim_reshi_pot(int v)
{
	bool notice = FALSE;
...
/*
 * Set "p_ptr->tim_resrare_pot", notice observable changes
 */
bool set_tim_resrare_pot(int v)
{
	bool notice = FALSE;
	...
	if (v)
	{
		...
		{
			msg_print("You feel highly resistant!");
			notice = TRUE;
		}
	}
	...
	else
	{
		if (p_ptr->tim_resrare_pot)
		{
			msg_print("You no longer feel highly resistant.");
			notice = TRUE;
		}
	}

	/* Use the value */
	p_ptr->tim_resrare_pot = v;
...
/*
 * Set "p_ptr->tim_air_pot", notice observable changes
 */
bool set_tim_air_pot(int v)
{
	bool notice = FALSE;
	...
	else
	{
		if (p_ptr->tim_air_pot)
		{
			msg_print("You feel the need to breathe once more.");
			notice = TRUE;
		}
	}
...
/*
 * Set "p_ptr->tim_antimagic_pot", notice observable changes
 */
bool set_tim_antimagic_pot(int v)
{
	bool notice = FALSE;
	...
	if (v)
	{
		...
		{
			msg_print("You start generating an antimagic field!");
			notice = TRUE;
		}
	}
	...
	else
	{
		if (p_ptr->tim_antimagic_pot)
		{
			msg_print("You no longer generate an antimagic field.");
			notice = TRUE;
		}
	}

	/* Use the value */
	p_ptr->tim_antimagic_pot = v;
...
/*
 * Set "p_ptr->tim_timeflow_pot", notice observable changes
 */
bool set_tim_timeflow_pot(int v)
{
	bool notice = FALSE;
	...
	if (v)
	{
		...
		{
			msg_print("You stabilize the time-space continuum!");
			notice = TRUE;
		}
	}
	...
	else
	{
		if (p_ptr->tim_timeflow_pot)
		{
			msg_print("The time-space continuum is no longer stabilized.");
			notice = TRUE;
		}
	}

	/* Use the value */
	p_ptr->tim_timeflow_pot = v;
...
/*
 * Set "p_ptr->tim_regen_pot", notice observable changes
 */
bool set_tim_regen_pot(int v)
{
	bool notice = FALSE;
	...
	if (v)
	{
		...
		{
			msg_print("You start to regenerate!");
			notice = TRUE;
		}
	}
...
/*
 * Set "p_ptr->tim_power_pot", notice observable changes
 */
bool set_tim_power_pot(int v)
{
	bool notice = FALSE;
...
/*
 * Set "p_ptr->tim_manasilence", notice observable changes
 */
bool set_tim_manasilence(int v)
{
	bool notice = FALSE;
	...
	if (v)
	{
		...
		{
			msg_print("You don't have mana anymore!");
			notice = TRUE;
		}
	}
	...
	else
	{
		if (p_ptr->tim_manasilence)
		{
			msg_print("You're no longer silenced.");
			notice = TRUE;
		}
	}

	/* Use the value */
	p_ptr->tim_manasilence = v;
...
/*
 * Set "p_ptr->betweensickness", notice observable changes
 */
bool set_betweensickness(int v)
{
	bool notice = FALSE;
...
/*
 * Set "p_ptr->tim_infra_x", notice observable changes
 */
bool set_tim_infra_x(int v)
{
	bool notice = FALSE;
...
/*
 * Set "p_ptr->tim_infra_xx", notice observable changes
 */
bool set_tim_infra_xx(int v)
{
	bool notice = FALSE;
...
bool mon_take_hit(int m_idx, int dam, bool *fear, cptr note)
{
	...
	if (m_ptr->hp < 0)
	{
		...
		if ((r_ptr->flags5 & RF5_BA_ACID) || (r_ptr->flags5 & RF5_BA_ELEC) || (r_ptr->flags5 & RF5_BA_FIRE) || (r_ptr->flags5 & RF5_BA_COLD) || (r_ptr->flags5 & RF5_BA_POIS) || (r_ptr->flags5 & RF5_BA_NETH) || (r_ptr->flags5 & RF5_BA_WATE) || (r_ptr->flags4 & RF4_BA_NUKE) || (r_ptr->flags5 & RF5_BA_MANA) || (r_ptr->flags5 & RF5_BA_DARK) || (r_ptr->flags4 & RF4_BA_CHAO) || (r_ptr->flags12 & RF12_BA_METE) )
		{
			int inc = m_ptr->level * 2;
			PRAY_GOD(GOD_NIENNA) {
				inc *= 3;
