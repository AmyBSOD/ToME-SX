...
void randomdungeondamage(void)
{
	...
	switch (dudrand) {
		...
		case 32:
			...
			break;
		case 33:
			printf("E:1d%d:%d:RADIOWAVE\n", random_number(6), 9 + random_number(31) );
			break;
		case 34:
			printf("E:1d%d:%d:AMOEBAE\n", random_number(6), 9 + random_number(31) );
			break;
	}
	...
	for (d_id = 0; d_id <= 106; d_id++) {
		...
		switch (d_id) {
			...
			case 69:
				...
				break;
			case 70:
				printf("N:70:Space Base\n");
				printf("D:Spa:a teleporter beacon leading to a spaceship.\n");
				printf("W:20:31:1:0:25:180\n");
				break;
			case 71:
				printf("N:71:Sewer\n");
				printf("D:Sew:a hatch leading into the sewer plant.\n");
				printf("W:32:38:1:0:25:180\n");
				break;
			case 72:
				printf("N:72:Gamma Caves\n");
				printf("D:Gam:the entrance to the Gamma Caves.\n");
				printf("W:39:45:1:0:25:190\n");
				break;
			case 73:
				printf("N:73:Mainframe\n");
				printf("D:Mai:the entrance to the Mainframe.\n");
				printf("W:46:50:1:0:35:180\n");
				break;
			case 74:
				printf("N:74:Mount Fate\n");
				printf("D:MFa:a way to the top of the Mount Fate.\n");
				printf("W:65:99:1:0:14:160\n");
				break;
			case 75:
				printf("N:75:Wild Mine\n");
				printf("D:WMi:the entrance to a wild mine.\n");
				printf("W:1:10:1:0:15:150\n");
				break;
			case 76:
				printf("N:76:Femmy's Cave\n");
		...
		switch (d_id) {
			...
			case 69: /* Mount Olympus */
				...
				break;
			case 73: /* Mainframe */
				printf("F:FINAL_GUARDIAN_5342\n");
				break;
			case 74: /* Mount Fate */
				printf("F:NO_RECALL | NO_EASY_MOVE\n");
				break;
			case 75: /* Wild Mine */
				printf("F:FINAL_GUARDIAN_5345\n");
				break;
			...
			if (random_number(3) == 2) {
				...
				switch (contnum) {
					...
					case 132:
						...
						break;
					case 133:
						printf("# based on Vana Temple\n", contnum);
						printf("L:1:90:84:10:84:0\n");
						printf("A:98:100:56:0:56:0:98:98\n");
						printf("O:25:5:40:20\n");
						printf("F:SMALL | WATER_RIVER | ADJUST_LEVEL_2 | NO_DESTROY | SAND_VEIN\n");
						printf("F:NO_SHAFT\n");
						printf("R:95:3\n");
						printf("M:POWERFUL | SMART | RES_TIME |\n");
						printf("S:BR_TIME | TRAPS |\n");
						printf("R:5:0\n");
						break;
					case 134:
						printf("# randomized sand temple\n", contnum);
						printf("L:1:90:84:10:84:0\n");
						printf("A:98:100:56:0:56:0:98:98\n");
						printf("O:25:5:40:20\n");
						randomfillmethod();
						if (random_number(10) == 1) printf("F:FLAT\n");
						if (random_number(14) == 1) printf("F:CAVERN\n");
						if (random_number(13) == 1) printf("F:CAVE\n");
						if (random_number(2) == 1) printf("F:RANDOM_TOWNS\n");
						if (random_number(20) == 1) printf("F:CIRCULAR_ROOMS\n");
						if (random_number(25) == 1) printf("F:DOUBLE\n");
						if (random_number(10) == 1) printf("F:WATER_RIVER\n");
						if (random_number(20) == 1) printf("F:WATER_RIVERS\n");
						if (random_number(10) == 1) printf("F:SAND_VEIN\n");
						if (random_number(100) == 1) printf("F:QUARTZ_VEIN\n");
					...
					case 135:
					case 136:
						printf("# based on Space Base\n", contnum);
						printf("L:1:100:1:0:1:0\n");
						printf("A:56:100:56:0:56:0:57:58\n");
						printf("O:20:20:20:20\n");
						printf("F:NO_STREAMERS | NO_SHAFT | SMALL | NO_DESTROY | RANDOM_TOWNS | \n");
						printf("F:FILL_METHOD_2 \n");
						printf("R:20:0\n");
						printf("R:80:3\n");
						printf("M:SMART | CAN_SPEAK | OPEN_DOOR | TAKE_ITEM | NONLIVING | \n");
						printf("S:ARROW_1 | ARROW_2 | ARROW_3 | ARROW_4 | ROCKET | S_BUG | S_RNG | \n");
						break;
					case 137:
					case 138:
						printf("# based on Sewer\n", contnum);
						printf("L:88:60:226:30:84:10\n");
						printf("A:56:100:56:0:56:0:57:226\n");
						printf("O:10:20:5:20\n");
						printf("F:NO_SHAFT | SMALL | NO_DESTROY | WATER_RIVER | CAVE | \n");
						printf("F:FILL_METHOD_2 \n");
						printf("E:2d4:40:POISON\n");
						printf("R:20:0\n");
						printf("R:80:3\n");
						printf("M:R_CHAR_mrJ | AQUATIC | SPIDER | \n");
						break;
					case 139:
					case 140:
						printf("# based on Gamma Caves\n", contnum);
						printf("L:1:90:124:10:1:0\n");
						printf("A:211:100:56:0:56:0:57:124\n");
						printf("O:0:30:10:40\n");
						printf("F:NO_SHAFT | SMALL | NO_DESTROY | RANDOM_TOWNS | \n");
						printf("F:FILL_METHOD_2 | MAGMA_VEIN \n");
						printf("E:1d10:30:ETHER\n");
						printf("R:10:0\n");
						printf("R:90:3\n");
						printf("M:RES_ETHE |\n");
						printf("S:BR_ETHE | BR_NUKE | BA_NUKE | S_BUG | S_RNG | \n");
						break;
					case 141:
					case 142:
						printf("# based on Mainframe\n", contnum);
						printf("L:1:100:1:0:1:0\n");
						printf("A:56:100:56:0:56:0:57:58\n");
						printf("O:0:40:10:50\n");
						printf("G:maze\n");
						printf("F:NO_STREAMERS | NO_SHAFT | SMALL | NO_DESTROY | \n");
						printf("F:FILL_METHOD_2 | NO_TELEPORT | TOWER | \n");
						printf("R:10:0\n");
						printf("R:90:3\n");
						printf("M:R_CHAR_U | DEMON\n");
						break;
					case 143:
						printf("# randomized sewer\n", contnum);
						printf("L:88:60:226:30:84:10\n");
						printf("A:56:100:56:0:56:0:57:226\n");
						printf("O:10:20:5:20\n");
						randomfillmethod();
						...
						if (random_number(100) == 1) printf("F:QUARTZ_VEIN\n");
						if (random_number(100) == 1) printf("F:MAGMA_VEIN\n");
						if (random_number(7) == 1) printf("F:NO_DOORS\n");
						if (random_number(6) == 1) printf("F:NO_DESTROY\n");
						if (random_number(20) == 1) printf("F:EMPTY\n");
						if (random_number(50) == 1) printf("F:NO_STREAMERS\n");
						if (random_number(5) == 1) printf("F:NO_SHAFT\n");
						...
						break;
					case 144:
						printf("# randomized gamma caves\n", contnum);
						printf("L:1:90:124:10:1:0\n");
						printf("A:211:100:56:0:56:0:57:124\n");
						printf("O:0:30:10:40\n");
						randomfillmethod();

						if (random_number(35) == 1) printf("F:FLAT\n");
						if (random_number(20) == 1) printf("F:CAVERN\n");
						if (random_number(20) == 1) printf("F:CAVE\n");
						if (random_number(25) == 1) printf("F:FORGET\n");
						if (random_number(2) == 1) printf("F:RANDOM_TOWNS\n");
						if (random_number(15) == 1) printf("F:CIRCULAR_ROOMS\n");
						if (random_number(35) == 1) printf("F:DOUBLE\n");
						if (random_number(15) == 1) printf("F:WATER_RIVER\n");
						if (random_number(30) == 1) printf("F:WATER_RIVERS\n");
						if (random_number(30) == 1) printf("F:SAND_VEIN\n");
						if (random_number(30) == 1) printf("F:QUARTZ_VEIN\n");
					...
					case 146:
					case 147:
						printf("# based on Mount Fate\n", contnum);
						printf("L:93:90:123:1:94:9\n");
						printf("A:51:75:56:25:0:0:216:92\n");
						printf("O:10:30:10:30\n");
						printf("E:1d1:40:RAISE\n");
						printf("E:1d6:50:MIND\n");
						printf("F:CAVE | LAVA_RIVERS | BIG |\n");
						printf("F:FILL_METHOD_3 |\n");
						printf("R:10:3\n");
						printf("M:NAZGUL | REVBOSS\n");
						printf("R:40:3\n");
						printf("M:WILD_TOWN | WILD_SHORE | WILD_OCEAN | WILD_WASTE |\n");
						printf("M:WILD_WOOD | WILD_VOLCANO | WILD_MOUNTAIN | WILD_GRASS |\n");
						printf("R:50:0\n");
						break;
					case 148:
					case 149:
						printf("# based on Wild Mine\n", contnum);
						printf("L:1:40:94:30:207:30\n");
						printf("A:56:40:51:30:50:30:57:58\n");
						printf("O:30:20:5:30\n");
						printf("F:CAVERN | \n");
						printf("F:FILL_METHOD_3 \n");
						printf("R:10:1\n");
					...
					case 150:
					case 151:
						printf("# based on Femmy's Cave\n", contnum);
						printf("L:1:88:84:10:227:2\n");
						printf("A:56:90:229:5:239:5:215:204\n");
						printf("O:30:5:30:30\n");
					...
					case 153:
						...
						if (random_number(20) == 1) printf("F:FLAT\n");
						if (random_number(25) == 1) printf("F:LAVA_RIVER\n");
						if (random_number(5) == 1) printf("F:CAVERN\n");
						if (random_number(5) == 1) printf("F:CAVE\n");
						if (random_number(50) == 1) printf("F:FORGET\n");
						if (random_number(2) == 1) printf("F:RANDOM_TOWNS\n");
						...
						if (random_number(30) == 1) printf("F:SAND_VEIN\n");
						if (random_number(12) == 1) printf("F:QUARTZ_VEIN\n");
					...
					case 154:
						...
						if (random_number(3) == 1) printf("F:CAVE\n");
						...
						if (random_number(15) == 1) printf("F:WATER_RIVER\n");
						if (random_number(30) == 1) printf("F:WATER_RIVERS\n");
						if (random_number(15) == 1) printf("F:SAND_VEIN\n");
						if (random_number(12) == 1) printf("F:QUARTZ_VEIN\n");
						if (random_number(12) == 1) printf("F:MAGMA_VEIN\n");
						if (random_number(20) == 1) printf("F:NO_DOORS\n");
						if (random_number(20) == 1) printf("F:NO_DESTROY\n");
						...
						break;
					case 155:
						printf("# based on Nessa Temple\n", contnum);
						printf("L:89:80:230:15:229:5\n");
						printf("A:96:90:50:10:56:0:202:202\n");
						printf("O:30:10:30:10\n");
						printf("F:WATER_RIVER | WATER_RIVERS | ADJUST_LEVEL_2 | NO_DOORS | FLAT\n");
						printf("F:NO_SHAFT | NO_GENO | MAGMA_VEIN\n");
						printf("R:95:3\n");
						printf("M:COLD_BLOOD | DEMON | AI_ANNOY | RES_CHAO |\n");
						printf("R:5:0\n");
						break;
					case 156:
						printf("# randomized speed forest\n", contnum);
						printf("L:89:80:230:15:229:5\n");
						printf("A:96:90:50:10:56:0:202:202\n");
						printf("O:30:10:30:10\n");
						randomfillmethod();
						...
						if (random_number(20) == 1) printf("F:NO_DESTROY\n");
						if (random_number(22) == 1) printf("F:EMPTY\n");
						if (random_number(40) == 1) printf("F:NO_STREAMERS\n");
						...
						break;
					case 157:
						printf("# based on Lorien Temple\n", contnum);
						printf("L:89:80:88:15:91:5\n");
						printf("A:96:90:89:10:56:0:96:96\n");
						printf("O:20:20:15:20\n");
						...
						break;
					case 158:
						printf("# randomized sleep forest\n", contnum);
						printf("L:89:80:88:15:91:5\n");
						printf("A:96:90:89:10:56:0:96:96\n");
						printf("O:20:20:15:20\n");
						randomfillmethod();
						...
						if (random_number(10) == 1) printf("F:WATER_RIVER\n");
						if (random_number(15) == 1) printf("F:WATER_RIVERS\n");
						if (random_number(24) == 1) printf("F:SAND_VEIN\n");
						if (random_number(20) == 1) printf("F:QUARTZ_VEIN\n");
						if (random_number(20) == 1) printf("F:MAGMA_VEIN\n");
						if (random_number(7) == 1) printf("F:NO_DOORS\n");
						if (random_number(10) == 1) printf("F:NO_DESTROY\n");
