...
function __birth_hook_objects()
	...
	if get_class_name() == "Young Priest" then
		local obj = create_object(TV_BOOK, 255);
		obj.pval = find_spell("Icy Wind")
		obj.ident = bor(obj.ident, IDENT_MENTAL, IDENT_KNOWN)
		inven_carry(obj, FALSE)
		end_object(obj)
	end
	...
	if get_class_name() == "Speed Priest" then
		local obj = create_object(TV_BOOK, 255);
		obj.pval = find_spell("Confusion Fu")
		obj.ident = bor(obj.ident, IDENT_MENTAL, IDENT_KNOWN)
		inven_carry(obj, FALSE)
		end_object(obj)
	end
	if get_class_name() == "Sleep Priest" then
		local obj = create_object(TV_BOOK, 255);
		obj.pval = find_spell("Sleep Powder")
		obj.ident = bor(obj.ident, IDENT_MENTAL, IDENT_KNOWN)
		inven_carry(obj, FALSE)
		end_object(obj)
	end
