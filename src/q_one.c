...
bool quest_one_move_hook(char *fmt)
{
	...
	if (cquest.status == QUEST_STATUS_UNTAKEN)
	{
		...
		GOD(GOD_OROME)
		{
			cmsg_print(TERM_YELLOW, "'Also, Orome will abandon you if you wear it.'");
		}

		GOD(GOD_NIENNA)
		{
			cmsg_print(TERM_YELLOW, "'Also, Nienna will abandon you if you wear it.'");
		}

		GOD(GOD_ESTE)
		{
			cmsg_print(TERM_YELLOW, "'Also, Este will abandon you if you wear it.'");
		}
		...
		GOD(GOD_NESSA)
		{
			cmsg_print(TERM_YELLOW, "'Also, Nessa will abandon you if you wear it.'");
		}

		GOD(GOD_LORIEN)
		{
			cmsg_print(TERM_YELLOW, "'Also, Lorien will abandon you if you wear it.'");
		}
		...
		GOD(GOD_INGEBORG)
		{
			cmsg_print(TERM_YELLOW, "'Ingeborg will abandon you when you do, but you must do it anyway!'");
		}
