...
extern move_info_type move_info_hard[9];
extern tactic_info_type tactic_info_hard[9];
...
extern monster_power monster_powers[224];
...
extern u32b alchemist_known_artifacts[11];
...
extern void map_area_clair(void);
extern void map_area_lower(void);
...
extern void scatter_nolos(int *yp, int *xp, int y, int x, int d, int m);
...
extern void do_cmd_go_up(bool pasthook);
...
extern void do_cmd_alchemist(int crafttype);
...
extern void do_cmd_unbeliever(void);
extern void do_cmd_runecrafter(int crafttype);
...
extern void player_flags(u32b* f1, u32b* f2, u32b* f3, u32b* f4, u32b* f5, u32b* f6, u32b* f7, u32b* f8, u32b* f9, u32b* f10, u32b* esp);
...
extern bool room_alloc(int x,int y,int crowded,int by0,int bx0,int *xx,int *yy);
extern bool room_alloc_princ(int x,int y,int crowded,int by0,int bx0,int *xx,int *yy);
...
extern bool apply_flags_set(s16b a_idx, s16b set_idx, u32b *f1, u32b *f2, u32b *f3, u32b *f4, u32b *f5, u32b *f6, u32b *f7, u32b *f8, u32b *f9, u32b *f10, u32b *esp);
...
extern void object_flags(object_type *o_ptr, u32b *f1, u32b *f2, u32b *f3, u32b *f4, u32b *f5, u32b *f6, u32b *f7, u32b *f8, u32b *f9, u32b *f10, u32b *esp);
extern void object_flags_known(object_type *o_ptr, u32b *f1, u32b *f2, u32b *f3, u32b *f4, u32b *f5, u32b *f6, u32b *f7, u32b *f8, u32b *f9, u32b *f10, u32b *esp);
...
extern void dgn_background_damage(int);
...
extern void teleport_player_directed_DM(int rad, int dir);
...
extern bool hates_pois(object_type *o_ptr);
...
extern int set_pois_destroy(object_type *o_ptr);
...
extern bool detect_traps_nasty(int rad);
...
extern void fill_area_random_terrain(int y1, int x1, int r, int terrchance);
...
extern bool disarm_trap_single(int dir);
...
extern bool teleport_monster_single(int dir);
extern bool door_creation(void);
extern bool trap_creation(void);
extern bool glyph_creation(void);
extern bool destroy_doors_touch(void);
extern bool destroy_traps_touch(void);
extern bool destroy_traps_touch_nasty(void);
...
extern int random_fleecy_color(void);
...
extern void apply_flags(u32b f1, u32b f2, u32b f3, u32b f4, u32b f5, u32b f6, u32b f7, u32b f8, u32b f9, u32b f10, u32b esp, s16b pval, s16b tval, s16b to_h, s16b to_d, s16b to_a);
...
extern bool set_temp_res_blind(int v);
extern bool set_temp_res_conf(int v);
extern bool set_temp_res_fear(int v);
extern bool set_temp_res_hallu(int v);
...
extern bool set_tim_peace(int v);
extern bool set_tim_device(int v);
extern bool set_tim_elemlull(int v, int elemstr);
extern bool set_tim_magbreath(int v, int elemstr);
extern bool set_tim_macarena(int v, int elemstr);
extern bool set_tim_savmus(int v, int elemstr);
extern bool set_tim_minersong(int v, int elemstr);
extern bool set_tim_stealthmus(int v, int elemstr);
extern bool set_tim_warboogie(int v, int elemstr);
extern bool set_tim_tankmus(int v, int elemstr);
extern bool set_tim_slaughtersong(int v, int elemstr);
extern bool set_tim_mightymus(int v, int elemstr);
...
extern bool set_tim_dragonblood_fire(int v);
extern bool set_tim_dragonblood_cold(int v);
extern bool set_tim_dragonblood_elec(int v);
extern bool set_tim_dragonblood_acid(int v);
extern bool set_tim_esp_pot(int v);
extern bool set_tim_levi_pot(int v);
extern bool set_tim_jolt_fa(int v);
extern bool set_tim_boost_pot(int v);
extern bool set_tim_luck_pot(int v);
extern bool set_tim_reshi_pot(int v);
extern bool set_tim_resrare_pot(int v);
extern bool set_tim_air_pot(int v);
extern bool set_tim_antimagic_pot(int v);
extern bool set_tim_timeflow_pot(int v);
extern bool set_tim_regen_pot(int v);
extern bool set_tim_power_pot(int v);
extern bool set_tim_infra_x(int v);
extern bool set_tim_infra_xx(int v);
...
extern bool curse_shooter(void);
extern bool curse_jewelry(void);
extern bool curse_leftring(void);
extern bool curse_rightring(void);
extern bool curse_amulet(void);
extern bool curse_light(void);
extern bool curse_ammo(void);
extern bool curse_tool(void);
