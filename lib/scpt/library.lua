...
library_quest.bookable_spells =
{
	...
	NOXIOUSCLOUD, POISONBLOOD, AIRWINGS, INVISIBILITY, THUNDERSTORM, STERILIZE,
	STONESKIN, DIG, STONEPRISON, STRIKE, SHAKE, SEISMAGNITUDE,
	...
	MANWE_BLESS, MANWE_SHIELD, MANWE_AVATAR, MANWE_CALL,
	...
	INGEBORG_STAR_DESTRUCTION, INGEBORG_DISINTEGRATE, INGEBORG_BLACK_HOLE, INGEBORG_WILD_MAGIC, INGEBORG_EVERYTHING_BURNS,
